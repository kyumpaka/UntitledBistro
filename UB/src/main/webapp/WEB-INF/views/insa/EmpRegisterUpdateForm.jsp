	...
	<form name="EmpRegisterUpdateForm"  id="update" method="post" enctype="multipart/form-data">
		<table cellspacing='1' cellpadding='0' border='0' bgcolor='#000000'align='center' >
			...
			<tr>
				...
				<td>?œê¸‰<input type="radio" id="empregister_payclassfiy" name="empregister_payclassfiy" value="?œê¸‰">
				?¼ê¸‰<input type="radio" id="empregister_payclassfiy"name="empregister_payclassfiy" value="?¼ê¸‰">
				</td>
			...
			<tr>
				...
				<td colspan='2'><input type="radio" name="empregister_leavecompany" id="empregister_leavecompany" value="?¬ì§ì¤?">?¬ì§ì¤?
				<input type="radio" name="empregister_leavecompany"  id="empregister_leavecompany" value="?´ì§">?´ì§
				</td>
			</tr>
			<tr>
...
=========
				<td class='ti' colspan='3'>?œê¸‰</td>
				<td class='ti' colspan='3'>?œê¸‰</td>
				<td colspan='2'><input type="number" name="empregister_paytime" id="empregister_paytime" value="${b.empregister_paytime }">ì²œì›</td>
				<td class='ti' colspan='1'>?¼ê¸‰</td>
				<td colspan='2'><input type="number" name="empregister_payday" id="empregister_payday" value="${b.empregister_payday }">ë§Œì›</td>
			...
			<tr>
				...
				<td colspan='3'><input type="number"
					name="empregister_workplan"  id="empregister_workplan" value="${b.empregister_workplan}">?œê°„
					</td>
				<td>
			<input type="button" onclick="test1()" value="?˜ì •" />
			</td>
			</tr>
		</table>	
	</form>
