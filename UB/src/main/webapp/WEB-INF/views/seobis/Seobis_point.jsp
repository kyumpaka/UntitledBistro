                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="Seobis_createMember" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="member_addr1" placeholder="상세주소" class="form-control"><small class="form-text text-muted">This is a help text</small></div>
                                    </div>
