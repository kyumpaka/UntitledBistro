                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">     
                            <li><i class="fa fa-id-badge"></i><a href="../balju/Balju_Plan">계획 등록</a></li>
                            <li><i class="fa fa-bars"></i><a href="../balju/Balju_Plan_Result">계획 현황</a></li>
                            <li><i class="fa fa-id-card-o"></i><a href="../balju/Balju">발주 등록</a></li>
                            <li><i class="fa fa-exclamation-triangle"></i><a href="../balju/Balju_Search">발주 조회</a></li>
                            <li><i class="fa fa-spinner"></i><a href="../balju/Balju_Result">발주 현황</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
