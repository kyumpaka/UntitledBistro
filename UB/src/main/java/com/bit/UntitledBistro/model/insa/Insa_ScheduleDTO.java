...
private Date schedule_workingend; //퇴근시간
private int schedule_workingtime; //일한시간
private int schedule_workingdate;//당월근무일수
private Date schedule_hollydaystart;//휴가시작
private Date schedule_hollydayend;//휴가종료
...
public int getSchedule_workingtime() {
	return schedule_workingtime;
}
public void setSchedule_workingtime(int schedule_workingtime) {
...
public Date getSchedule_hollydaystart() {
	return schedule_hollydaystart;
}
public void setSchedule_hollydaystart(Date schedule_hollydaystart) {
	this.schedule_hollydaystart = schedule_hollydaystart;
}
public Date getSchedule_hollydayend() {
	return schedule_hollydayend;
}
public void setSchedule_hollydayend(Date schedule_hollydayend) {
...
public String toString() {
	return "Insa_ScheduleDTO [schedule_no=" + schedule_no + ", schedule_empregister_empnum="
			...
			+ ", schedule_workingdate=" + schedule_workingdate + ", schedule_hollydaystart=" + schedule_hollydaystart
			+ ", schedule_hollydayend=" + schedule_hollydayend + "]";
} 
