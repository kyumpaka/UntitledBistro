...
public class Insa_EmpRegisterDTO {
	...
	private int empregister_age; // 나이
	...
	public int getEmpregister_age() {
		return empregister_age;
	}

	public void setEmpregister_age(int empregister_age) {
	...
	public void setEmpregister_workplan(int empregister_workplan) {
