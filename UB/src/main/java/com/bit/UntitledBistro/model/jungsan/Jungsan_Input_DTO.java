...
public class Jungsan_Input_DTO {
	...
	private String jungsan_input_date2;
	...
	public String getJungsan_input_date2() {
		return jungsan_input_date2;
	}
	public void setJungsan_input_date2(String jungsan_input_date2) {
		this.jungsan_input_date2 = jungsan_input_date2;
	}
	...
	public String getPostdatepicker() {
		return postdatepicker;
	}
	public void setPostdatepicker(String postdatepicker) {
	...
	public String toString() {
		return "Jungsan_Input_DTO [jungsan_input_cash=" + jungsan_input_cash + ", jungsan_input_card="
				...
				+ jungsan_input_date + ", jungsan_input_date2=" + jungsan_input_date2 + ", month_cash=" + month_cash
				+ ", month_card=" + month_card + ", month_worktime=" + month_worktime + ", month_expenditure="
				+ month_expenditure + ", month_point=" + month_point + ", month_refund=" + month_refund + ", month_sum="
				+ month_sum + ", month_real_sum=" + month_real_sum + ", month_date=" + month_date + ", difference="
				+ difference + ", difference_month=" + difference_month + ", difference_date=" + difference_date
