...
public interface Jungsan_Input_DAO {
	...
	public void insert_Initial_value(Jungsan_Input_DTO dto);				//월마감 초기값
	public int Benchmark();													//기준점
	public void Show_Month(Jungsan_Input_DTO dto);							//Month데이터 유무파악
	public int count_difference();											//컬럼수
	public void insert_difference(Jungsan_Input_DTO dto);					//초기값
	public void update_difference(Jungsan_Input_DTO dto);					//일차액 수정
	public void update_difference_Month(Jungsan_Input_DTO dto);				//월차액 수정
	public void Show_difference(Jungsan_Input_DTO dto);						//difference데이터 유무파악
	public int to_difference();												//이번달 일차액 합
	public List<Jungsan_Input_DTO> differenceList(HashMap map); 				//월차액
}
