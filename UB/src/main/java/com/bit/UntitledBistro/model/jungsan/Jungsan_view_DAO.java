...
public interface Jungsan_view_DAO {
	...
	public int today_point(); // 금일 사용 포인트
	////////////////////////////// 제품////////////////////////////////

	public int menucount_total(); // 메뉴 총 갯수

	public int menucount_drink(); // 현재 주류 갯수
	...
	public void insert_Initial_value(Jungsan_view_DTO dto); // 현재null포인트 초기값
