...
$(document).ready(function() {
	$("#grid").jqGrid({
        ...
        colModel:[
            {name:'payment_Sales_No', width:70, align:'center', sortable:false},
            ...
            {name:'payment_No', width:80, align:"center", formatter: delButton }
        ],
        caption: "판매 내역",
        ...
        onSelectRow : function (rowid) {
        	   var no = jQuery("#grid").getRowData(rowid).payment_Sales_No;
        	   $.ajax({
...
function dateSearch() {
	...
	if(type == 'payment_Date') {
		...
		$("#predatepicker").datepicker({dateFormat:'yymmdd'});
		$("#postdatepicker").datepicker({dateFormat:'yymmdd'});
